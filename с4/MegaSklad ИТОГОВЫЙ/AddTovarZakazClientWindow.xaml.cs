...
namespace MegaSklad
{
    public partial class AddTovarZakazClientWindow : Window
    {
        private List<Товары> _tovaryData;
        public ТоварыЗаказаКлиентуViewModel NewTovar { get; set; }

        public AddTovarZakazClientWindow()
        {
            InitializeComponent();
            Loaded += AddTovarToZakazClientWindow_Loaded;
        }

        private async void AddTovarToZakazClientWindow_Loaded(object sender, RoutedEventArgs e)
        {
        ...
        private void AddButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                NewTovar = new ТоварыЗаказаКлиентуViewModel
                {
